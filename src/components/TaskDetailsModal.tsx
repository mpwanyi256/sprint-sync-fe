...
import { Clock, User, Calendar, Save, X, Star, MoreHorizontal, History } from 'lucide-react'
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[900px] max-h-[95vh] overflow-y-auto p-0">
        ...
        <div className="flex p-6 items-center space-x-4">
          ...
          <DialogTitle className="text-2xl font-bold text-gray-900">Task Details</DialogTitle>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <Badge className={cn("text-sm", getStatusColor(editedTask.status))}>
          ...
          <div className="flex justify-end pt-4 border-t border-gray-200">
            <Button onClick={handleSaveTask} className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white">
