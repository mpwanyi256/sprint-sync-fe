...
const BoardView = ({ onViewTaskDetails }: BoardViewProps) => {
  ...
  return (
    <div className='flex overflow-x-auto pb-4 gap-6 items-start h-full'>
      <div id='BACKLOG' className='w-[320px]'>
        <TaskColumn
          title='Backlog'
          status='BACKLOG'
      ...
      <div id='IN_PROGRESS' className='w-[320px]'>
        <TaskColumn
          title='In Progress'
          status='IN_PROGRESS'
          onViewTaskDetails={onViewTaskDetails}
      ...
      <div id='IN_REVIEW' className='w-[320px]'>
        <TaskColumn
          title='In Review'
          status='IN_REVIEW'
          onViewTaskDetails={onViewTaskDetails}
